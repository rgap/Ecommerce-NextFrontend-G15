          ...
          <div className="flex flex-col">
            ...
            <section className="text-center md:text-right mr-0 md:mr-0 lg:mr-14 px-10 md:px-0">
              <div className="gap-4 flex flex-col mt-8">
                <p className="font-semibold md:text-md">SUBTOTAL: S/. {totalCart} PEN</p>
                <p className="text-xs break-words">(*) Los impuestos y gastos de envío se calculan en la pantalla de pago.</p>
                <div className="justify-center md:justify-end flex">
                  <div className="w-[185px] h-[50px]">
                    <Button ruta="/cart-info" text="Pagar Pedido" type="submit" variant="primary" />
                  </div>
                </div>
              </div>
            </section>
